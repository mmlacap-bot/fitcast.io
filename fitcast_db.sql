...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en_GB",server:"1",table:"",db:"",token:"29674f7076712e6b753d535f2140264d",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.1",auth_type:"config",user:"root"});
...
<body>
    <div id="pma_navigation" class="d-print-none" data-config-navigation-width="252">
  ...
  <a href="index.php?route=/table/recent-favorite&db=fitcast_db&table=admins">
    `fitcast_db`.`admins`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=fitcast_db&table=admin">
    `fitcast_db`.`admin`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=fitcast_db&table=users">
    `fitcast_db`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=fitcast_db&table=contacts">
    `fitcast_db`.`contacts`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=fitcast_db&table=workouts">
    `fitcast_db`.`workouts`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=email_system&table=notifications">
    `email_system`.`notifications`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=email_system&table=users">
    `email_system`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=email_system&table=messages">
    `email_system`.`messages`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=employees&table=employees">
    `employees`.`employees`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=php_demo&table=users">
    `php_demo`.`users`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          ...
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=app_db"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=app_db" title="Structure">app_db</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Y29sbGVnZQ==" data-vpath="cm9vdA==.Y29sbGVnZQ==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=college"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=college" title="Structure">college</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.ZW1haWxfc3lzdGVt" data-vpath="cm9vdA==.ZW1haWxfc3lzdGVt" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=email_system"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=email_system" title="Structure">email_system</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.ZW1wbG95ZWVz" data-vpath="cm9vdA==.ZW1wbG95ZWVz" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=employees"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=employees" title="Structure">employees</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.Zml0Y2FzdF9kYg==" data-vpath="cm9vdA==.Zml0Y2FzdF9kYg==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=fitcast_db"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=fitcast_db" title="Structure">fitcast_db</a>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander loaded container" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.a2FtYXlrcmFmdA==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
  ...
  <li class="database database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.a2FtYXlrcmFmdA==" data-vpath="cm9vdA==.a2FtYXlrcmFmdA==." data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=kamaykraft"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=kamaykraft" title="Structure">kamaykraft</a>
  ...
  <li class="database last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.a2FtYXlrcmFmdF9kYXRhYmFzZQ==" data-vpath="cm9vdA==.a2FtYXlrcmFmdA==.ZGF0YWJhc2U=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=kamaykraft_database"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=kamaykraft_database" title="Structure">kamaykraft_database</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.cGhwX2RlbW8=" data-vpath="cm9vdA==.cGhwX2RlbW8=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=php_demo"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=php_demo" title="Structure">php_demo</a>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          ...
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=school"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=school" title="Structure">school</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="29674f7076712e6b753d535f2140264d">
...
<tr>
  ...
  <td>
          <input type="number" name="NavigationWidth" id="NavigationWidth" value="252" class="custom">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="fitcast_db" targettable="admin">
            ...
            Queried time
                            ...
                            <span class="query">RENAME TABLE admin TO admins;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fitcast_db" targettable="admins">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
